       ...
       return ; // nao tem memoria
        ...
        if (inicio==NULL){ // lista vazia
            ...
            if (p->numero > corre->numero){ // insere antes a fileira
                corre->prox=p;
                corre->ant=p->ant->prox; // o anterior do novo corredor recebe o proximo anteiror do apontamento de p (desenha que você entende)
                p->ant->prox=corre; // o proximo anteiror do apontamento de p recebe o corredor
                 ...
                 p->prox=corre;   // corredor é adicionado no final da lista
            }
        }
   }
